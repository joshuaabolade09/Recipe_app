    ...
    <header className="bg-cream border-b border-borderSoft relative z-50">
      <div className="mx-auto flex max-w-6xl items-center justify-between px-4 py-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          {/* ✅ FIXED: Changed /modal to /planner */}
          <NavLink to="/planner" className={navLinkStyle}>Meal Planner</NavLink>
        </nav>
      ...
      {isOpen && (
        <div className="absolute top-full left-0 w-full bg-cream border-b border-borderSoft px-4 py-4 shadow-lg md:hidden">
          <nav className="flex flex-col gap-4" aria-label="Mobile navigation">
            {/* ✅ FIXED: Changed /home to / for consistency */}
            ...
            {/* ✅ FIXED: Changed /modal to /planner */}
            <NavLink to="/planner" className={navLinkStyle} onClick={() => setIsOpen(false)}>Meal Planner</NavLink>
