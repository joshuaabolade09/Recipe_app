...
export default function ModalPlanner() {

  const navigate= useNavigate()
   const savedRecipe= "planner";
...
console.log(weeklyBudget, weeklyPeople, weeklyMeals, weeklyDiet)


  function openPlannerRecipe(e){
...
<div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/40 backdrop-blur-sm">
  <div className="w-full max-w-md bg-white rounded-3xl shadow-[0_24px_60px_rgba(88,54,28,.18)] overflow-hidden">
    ...
    <div className="bg-gradient-to-br from-orange-50 to-white px-6 pt-6 pb-5 border-b border-orange-100">
      <div className="flex items-center justify-between mb-1">
        ...
        <button className="grid size-9 place-items-center rounded-xl border border-orange-100 text-[#8a5c45] hover:bg-orange-50 transition">
    ...
    <div className="px-6 py-5 flex flex-col gap-5">
      ...
      <div>
        ...
        <div className="relative">
          ...
          <input
            type="number" value={weeklyBudget} onChange={(e)=> setWeeklyBudget(e.target.value)}
            placeholder="20,000"
      ...
      <div>
        ...
        <div className="grid grid-cols-4 gap-2">
          {[1, 2, 3, 4].map((num) => (
            <button
              key={num} onClick={() => handleWeeklyPeople(num)}
      ...
      <div>
        ...
        <div className="grid grid-cols-3 gap-2">
          {[
            ...
            <button
              key={option.num} onClick={()=> handleWeeklyMeals(option.num)}
      ...
      <div>
        ...
        <div className="grid grid-cols-3 gap-2">
          {[
            ...
            <button
              key={option.value} onClick={()=> handleWeeklyDiet(option.value)}
    ...
    <div className="px-6 pb-6">
      <button onClick={(e)=>openPlannerRecipe()} className="group w-full flex items-center justify-center gap-2 rounded-2xl bg-[#ff7417] py-3.5 text-sm font-extrabold text-white shadow-[0_10px_28px_rgba(255,116,23,.28)] transition duration-300 hover:-translate-y-0.5 hover:bg-[#e85f08] hover:shadow-[0_16px_40px_rgba(255,116,23,.35)] focus-visible:ring-4 focus-visible:ring-orange-200 active:scale-[0.98]">
        Generate my plan
